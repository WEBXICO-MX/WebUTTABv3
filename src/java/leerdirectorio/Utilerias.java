...
public final class Utilerias
{
      ...
      while (y < encriptada.length())
      {
        ...
        if (xContrasena == xOriginal)
        {
          ...
          if (y == original.length()) {
            temporal = String.valueOf(temporal) + String.valueOf(original.charAt(1)); break;
          }
  ...
  public static double redondear(double numero, int decimales)
  {
    ...
    else if (decimales == ceros)
    {
      ...
      while (decimales - ceros < parte_decimal.length()) parte_decimal = String.valueOf(Math.round(Double.parseDouble(String.valueOf(parte_decimal)) / 10.0D));
      for (; ceros > 0; ceros--) {
        parte_decimal = "0".concat(String.valueOf(String.valueOf(parte_decimal)));
      }
    }
  ...
  public static Vector split(String pattern, String in)
  {
    ...
    while (true)
    {
      ...
      if (s2 != -1)
      {
        ...
        if ((_ == null) || (_.equals(""))) break;
        out.addElement(_); break;
      }
