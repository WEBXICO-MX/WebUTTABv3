<%-- 
    Document   : uploadIMG
    Created on : 04-jun-2015, 9:21:14
    Author     : Weiss
--%>
...
<div class="modal-header">
    ...
    <h4 class="modal-title">Subir imagen Aviso(s)</h4>
</div>
<div class="modal-body">
    <div class="te">
        Nombre: <s:property value="aviso.nombre"/><br/>
        Fecha de realización: <s:property value="aviso.fecha_realizacion"/><br/><br/>
        <s:form action="upload_img" namespace="/SistemasAdmin/avisos" method="POST" enctype="multipart/form-data" >
