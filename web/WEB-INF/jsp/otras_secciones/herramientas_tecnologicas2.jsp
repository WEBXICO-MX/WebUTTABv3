<%-- 
    Document   : herramientas_tecnologicas2
    Created on : 27-nov-2015, 14:39:43
    Author     : Weiss
--%>
...
<html lang="es">
    <head>
        ...
        <meta name="description" content="Universidad Tecnológica de Tabasco,Herramientas tecnológicas">
        <meta name="keywords" content="servicios,Herramientas tecnológicas,tsu,educación,tecnologías,ingeniería,industrial,tecnológica,uttab,desarrollo,química,procesos,tabasco,universidad,servicios,gastronomía,page,comunicación,negocios,administración,aviso,proyectos,alumnos,escolar,mantenimiento,institucional,programa,competencias">
        <!--[if IE]>
    ...
    <body>
                ...
                <article class="otras_secciones_contenido">
                    ...
                    <section class="otras_secciones_texto">
                        ...
                        <article class="otras_secciones_texto2 text_align_right">
                            <figure><img src="${pageContext.request.contextPath}/img/otras_secciones/herramientas_tecnologicas/office365_2-min.png" alt="Microsoft Office365"/></figure>
                        </article>
                        <div class="corte"></div>
                    </section>
                    <section class="otras_secciones_texto">
                        <article class="otras_secciones_texto1">
                            ...
                            <br/>
                            <a href="http://e5.onthehub.com/WebStore/ProductsByMajorVersionList.aspx?ws=d0ea9034-cf13-e211-a76f-f04da23e67f6&vsro=8&JSEnabled=1" target="_blank"><img src="${pageContext.request.contextPath}/img/otras_secciones/herramientas_tecnologicas/btn_ingresar-min.png" alt="Microsoft DreamSpark" /></a>
                            <div class="corte"></div>
                        </article>
                        <article class="otras_secciones_texto2 text_align_right">
                    ...
                    <section class="otras_secciones_texto">
                        <article class="otras_secciones_texto1">
                            ...
                            <br/>
                            <a href="http://www.autodesk.com/education/free-software/all" target="_blank"><img src="${pageContext.request.contextPath}/img/otras_secciones/herramientas_tecnologicas/btn_ingresar-min.png" alt="Autodesk" /></a>
                            <div class="corte"></div>
                        </article>
                        <article class="otras_secciones_texto2 text_align_right">
                            <figure><img src="${pageContext.request.contextPath}/img/otras_secciones/herramientas_tecnologicas/autodesk.png" alt="Autodesk"/></figure>
                        </article>
                        <div class="corte"></div>
                    </section>
                    <section class="otras_secciones_texto">
                        <article class="otras_secciones_texto1">
                            ...
                            <br/>
                            <a href="http://www-304.ibm.com/ibm/university/academic/pub/page/academic_initiative" target="_blank"><img src="${pageContext.request.contextPath}/img/otras_secciones/herramientas_tecnologicas/btn_ingresar-min.png" alt="IBM Academic Initiative" /></a>
                            <div class="corte"></div>
                        </article>
                        <article class="otras_secciones_texto2 text_align_right">
                            <figure><img src="${pageContext.request.contextPath}/img/otras_secciones/herramientas_tecnologicas/ibm_academic_initiative-min.png" alt="IBM Academic Initiative"/></figure>
                        </article>
                        <div class="corte"></div>
                    </section>
                    <section class="otras_secciones_texto">
                        <article class="otras_secciones_texto1">
                            ...
                            <br/>
                            <a href="http://www.cudi.edu.mx/" target="_blank"><img src="${pageContext.request.contextPath}/img/otras_secciones/herramientas_tecnologicas/btn_ingresar-min.png" alt="CUDI" /></a>
                        </article>
                        <article class="otras_secciones_texto2 text_align_right">
                            <figure><img src="${pageContext.request.contextPath}/img/otras_secciones/herramientas_tecnologicas/CUDI-min.png" alt="CUDI"/></figure>
                        </article>
                        <div class="corte"></div>
                    </section>
                    <section class="otras_secciones_texto">
                        <article class="otras_secciones_texto1">
                            ...
                            <br/>
                            <a href="http://www.academica.mx " target="_blank"><img src="${pageContext.request.contextPath}/img/otras_secciones/herramientas_tecnologicas/btn_ingresar-min.png" alt="Académica" /></a>
                            <div class="corte"></div>
                        </article>
                        <article class="otras_secciones_texto2 text_align_right">
                            <figure><img src="${pageContext.request.contextPath}/img/otras_secciones/herramientas_tecnologicas/academia-min.png" alt="Académica"/></figure>
                        </article>
                        <div class="corte"></div>
                    </section>
                    <section class="otras_secciones_texto">
                        <article class="otras_secciones_texto1">
                            ...
                            <br/>
                            <a href="https://www.yammer.com/uttab.edu.mx/" target="_blank"><img src="${pageContext.request.contextPath}/img/otras_secciones/herramientas_tecnologicas/btn_ingresar-min.png" alt="Yammer" /></a>
                            <div class="corte"></div>
                        </article>
                        <article class="otras_secciones_texto2 text_align_right">
                            <figure><img src="${pageContext.request.contextPath}/img/otras_secciones/herramientas_tecnologicas/yammer-min.png" alt="Yammer"/></figure>
                        </article>
                        <div class="corte"></div>
                    </section>
                    <section class="otras_secciones_texto">
                        <article class="otras_secciones_texto1">
                            ...
                            <br/>
                            <a href="http://www.microsoftvirtualacademy.com/" target="_blank"><img src="${pageContext.request.contextPath}/img/otras_secciones/herramientas_tecnologicas/btn_ingresar-min.png" alt="Microsoft Virtual Academy" /></a>
                            <div class="corte"></div>
                        </article>
                        <article class="otras_secciones_texto2 text_align_right">
                            <figure><img src="${pageContext.request.contextPath}/img/otras_secciones/herramientas_tecnologicas/microsoft_virtual_academy.png" alt="Microsoft Virtual Academy"/></figure>
                        </article>
                        <div class="corte"></div>
                    </section>
                    <section class="otras_secciones_texto">
                        <article class="otras_secciones_texto1">
                            ...
                            <br/>
                            <a href="http://www.educatornetwork.com/Sites/PD/ProfessionalDevelopment/Educators/Courses?lang=Spanish#es" target="_blank"><img src="${pageContext.request.contextPath}/img/otras_secciones/herramientas_tecnologicas/btn_ingresar-min.png" alt="Curso Enseñando con Tecnología"  /></a>
                            <div class="corte"></div>
                        </article>
                        <article class="otras_secciones_texto2 text_align_right">
                            <figure><img src="${pageContext.request.contextPath}/img/otras_secciones/herramientas_tecnologicas/microsoft_virtual_academy.png" alt="Microsoft Virtual Academy"/></figure>
                    ...
                    <section class="otras_secciones_texto">
                        <article class="otras_secciones_texto1">
                            ...
                            <br/>
                            <a href="http://www.tupuedesmexico.org/" target="_blank"><img src="${pageContext.request.contextPath}/img/otras_secciones/herramientas_tecnologicas/btn_ingresar-min.png" alt="Microsoft YouthSpark"  /></a>
                            <div class="corte"></div>
                        </article>
                        <article class="otras_secciones_texto2 text_align_right">
                            <figure><img src="${pageContext.request.contextPath}/img/otras_secciones/herramientas_tecnologicas/microsoft_youthspark.png" alt="Microsoft YouthSpark"/></figure>
                        </article>
                        <div class="corte"></div>
                    </section>
                    <section class="otras_secciones_texto_full">
                        <div id="herramientas_tecnologicas_paginacion">
                            <p><a href="javascript:void(0);" onclick="paginacion(1);"><span id="1" style="cursor: pointer;">1</span></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:void(0);" onclick="paginacion(2);" ><span id="2" style="cursor: pointer;">2</span></a></p>
                        </div>
                    </section>
                </article>
                <div class="corte"></div>
        ...
        <script>
            ...
            function paginacion(id)
            {
                if (id === 1)
                {
                    $("#1").addClass("herramientas_tecnologicas_paginacion_opcion");
                    $("#2").removeClass("herramientas_tecnologicas_paginacion_opcion");
                    $("article.otras_secciones_contenido section.otras_secciones_texto:nth-child(n+9)").hide();
                    $("article.otras_secciones_contenido section.otras_secciones_texto:nth-child(-n+8)").show();
                }
                else
                {
                    $("#1").removeClass("herramientas_tecnologicas_paginacion_opcion");
                    $("#2").addClass("herramientas_tecnologicas_paginacion_opcion");
                    $("article.otras_secciones_contenido section.otras_secciones_texto:nth-child(-n+9)").hide();
                    $("article.otras_secciones_contenido section.otras_secciones_texto:nth-child(n+9)").show();
                }
