            ...
            <section class="otras_secciones_section">
                ...
                <article class="otras_secciones_contenido">
                    <section class="otras_secciones_texto_full">
                        <img src="${pageContext.request.contextPath}/img/otras_secciones/herramientas_tecnologicas/herramientas_tecnologicas1-min.png" alt="Herramientas tecnológicas"/>
                    </section>
                    <section class="otras_secciones_texto">
                        ...
                        <article class="otras_secciones_texto2 text_align_right">
                            <img src="${pageContext.request.contextPath}/img/otras_secciones/herramientas_tecnologicas/app_uttab.png" alt="App UTTAB"/>
                        </article>
                        <div class="corte"></div>
                    </section>
                    <section class="otras_secciones_texto">
                        ...
                        <article class="otras_secciones_texto2 text_align_right">
                            <img src="${pageContext.request.contextPath}/img/otras_secciones/herramientas_tecnologicas/office365_2-min.png" alt="Microsoft Office365"/>
                        </article>
                        <div class="corte"></div>
                    </section>
                    <!--<section class="otras_secciones_texto">
                    ...
                    <section class="otras_secciones_texto">
                        ...
                        <article class="otras_secciones_texto2 text_align_right">
                            <img src="${pageContext.request.contextPath}/img/otras_secciones/herramientas_tecnologicas/ibm_academic_initiative-min.png" alt="IBM Academic Initiative"/>
                        </article>
                        <div class="corte"></div>
                    </section>
                    <section class="otras_secciones_texto">
                        ...
                        <article class="otras_secciones_texto2 text_align_right">
                            <img src="${pageContext.request.contextPath}/img/otras_secciones/herramientas_tecnologicas/CUDI-min.png" alt="CUDI"/>
                        </article>
                        <div class="corte"></div>
                    </section>
                    <section class="otras_secciones_texto">
                        ...
                        <article class="otras_secciones_texto2 text_align_right">
                            <img src="${pageContext.request.contextPath}/img/otras_secciones/herramientas_tecnologicas/academia-min.png" alt="Académica"/>
                        </article>
                        <div class="corte"></div>
                    </section>
                    <section class="otras_secciones_texto">
                        ...
                        <article class="otras_secciones_texto2 text_align_right">
                            <img src="${pageContext.request.contextPath}/img/otras_secciones/herramientas_tecnologicas/yammer-min.png" alt="Yammer"/>
                        </article>
                        <div class="corte"></div>
                    </section>
                    <section class="otras_secciones_texto">
