<%-- 
    Document   : radio
    Created on : 20-abr-2015, 8:39:20
    Author     : Weiss
--%>

<%@page contentType="text/html" pageEncoding="UTF-8" session="false"%>
<div id="sintonia_botones">
    <a href="javascript:void(0);" onclick="getContendView('radio2.action');"><img src="${pageContext.request.contextPath}/img/otras_secciones/radio/btn_radio-min.png" alt="Sintonía UTTAB 102.5 FM &#124; Radio" style="opacity:0.8;filter:alpha(opacity=80);"/></a>&nbsp;&nbsp;&nbsp;&nbsp;
...
<div id="sintonia_banner">
    <img src="${pageContext.request.contextPath}/img/otras_secciones/radio/sintonia1-min.png" alt=""/>
</div>
