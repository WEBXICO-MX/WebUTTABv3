<%-- 
    Document   : calendario_eventos_ajax
...
<s:if test="calendarioList.size() > 0">
    <table id="tabla_calendario_eventos">
        <thead>
            <tr>
                <th colspan="2"><a href="javascript:void(0);" class="prev-day">&LT;&LT;</a>&nbsp;&nbsp;<s:property value="fecha_completa"/> <s:property value="semana_completa"/>&nbsp;&nbsp;<a href="javascript:void(0);" class="next-day">&GT;&GT;</a></th>
            </tr>
        </thead>
        <tbody>
            <tr>
                <td colspan="2" class="fecha_actual"><s:property value="fecha_completa"/></td>
            </tr>
...
<s:else>
    <table id="tabla_calendario_eventos">
        <thead>
            <tr>
                <th colspan="2">&LT;&LT;&nbsp;&nbsp;<s:property value="fecha_completa"/>&nbsp;&nbsp;&GT;&GT;</th>
            </tr>
        </thead>
        <tbody>
            <tr>
                <td colspan="2" class="fecha_actual">No hay eventos disponibles para este día.</td>
            </tr>
        </tbody>
    </table> 
</s:else>
