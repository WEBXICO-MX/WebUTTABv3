...
<html lang="es">
    <head>
        <title>UTTAB &#124; Acreditaciones</title>
        <meta charset="UTF-8">
        <meta name="author" content="Depto. Desarrollo de sistemas UTTAB">
        <meta name="description" content="Universidad Tecnológica de Tabasco, Acreditaciones">
    ...
    <body>
        ...
        <div class="contenedor">
            <div class="area_titulo_acreditaciones"><h3>Acreditaciones</h3></div>
