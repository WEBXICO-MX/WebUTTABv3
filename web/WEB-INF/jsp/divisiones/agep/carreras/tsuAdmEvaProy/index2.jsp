<%-- 
    Document   : index2
    Created on : 10-nov-2015, 12:35:19
    Author     : Weiss
--%>
...
<html lang="es">
    <head>
        ...
        <meta name="keywords" content="TSU en Administración área Administración y Evaluación de Proyectos,tsu,educación,tecnologías,ingeniería,industrial,tecnológica,uttab,desarrollo,química,procesos,tabasco,universidad,servicios,gastronomía,page,comunicación,negocios,administración,aviso,proyectos,alumnos,escolar,mantenimiento,institucional,programa,competencias">
        <!--[if IE]>
        ...
        <main>
            <section class="carrera_section">
                <header class="carrera_titulo">
                    ...
                    <h1>TSU en Administración área Administración y Evaluación de Proyectos</h1>
                    <div class="corte"></div>
                </header>
                <article class="carrera_contenido">
                    <section class="carrera_portada">
                        <figure>
                            <img src="${pageContext.request.contextPath}/img/divisiones/carreras/portada_tsu_administracion_area_administracion_evaluación_proyectos.png" alt="TSU en Administración área Administración y Evaluación de Proyectos"/>
                    ...
                    <section class="carrera_texto">
                        <article class="carrera_texto1">
                            ...
                            <ul>
                                <li>Analista de proyectos de inversión</li>
                                <li>Promotor o analista financiero</li>
                                <li>Consultor independiente en desarrollo organizacional</li>
                                <li>Administrador de proyectos y de negocios</li>
                                <li>Consultor Jr. y prestador de servicios profesionales</li>
                            </ul><br/>
                        ...
                        <article class="carrera_texto2">
                            ...
                            <ul>
                                <li>Evaluar las situaciones financieras de empresas y organizaciones</li>
                                <li>Elaborar una planeación estratégica para alcanzar los objetivos</li>
                                <li>Proponer proyectos de inversión para nuevas unidades de producción</li>
                                <li>Formular nuevos proyectos y/o programas de inversión</li>
                                <li>Aplicar técnicas y métodos financieros para el desarrollo de la empresa</li>
                            </ul>
                        </article>
                        <div class="corte"></div>
                    </section>
