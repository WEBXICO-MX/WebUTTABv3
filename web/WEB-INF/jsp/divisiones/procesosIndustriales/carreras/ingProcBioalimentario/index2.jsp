<%-- 
    Document   : index2
    Created on : 10-nov-2015, 12:51:17
    Author     : Weiss
--%>
...
<html lang="es">
    <head>
        ...
        <meta name="keywords" content="Ingeniería en Procesos Bioalimentarios,tsu,educación,tecnologías,ingeniería,industrial,tecnológica,uttab,desarrollo,química,procesos,tabasco,universidad,servicios,gastronomía,page,comunicación,negocios,administración,aviso,proyectos,alumnos,escolar,mantenimiento,institucional,programa,competencias">
        <!--[if IE]>
        ...
        <main>
            <section class="carrera_section">
                <header class="carrera_titulo">
                    ...
                    <h1>Ingeniería en Procesos Bioalimentarios</h1>
                    <div class="corte"></div>
                </header>
                <article class="carrera_contenido">
                    <section class="carrera_portada">
                        <figure>
                            <img src="${pageContext.request.contextPath}/img/divisiones/carreras/portada_ing_procesos_bioalimentarios.png" alt="Ingeniería en Procesos Bioalimentarios"/>
                            ...
                            <a href="https://youtu.be/U523V1S7eYo" target="_blank"><img src="${pageContext.request.contextPath}/img/divisiones/carreras/btn_video.png" alt="Video" class="icono_video"/></a>
                            <!-- Plan de estudio -->
                    ...
                    <section class="carrera_texto">
                        <article class="carrera_texto1">
                            ...
                            <ul>
                                <li>La conservación de alimentos</li>
                                <li>Los análisis microbiológicos</li>
                                <li>Análisis de alimentos</li>
                                <li>Investigación e innovación de los alimentos</li>
                            ...
                            <ul>
                                <li>En laboratorios de control de calidad microbiológicos</li>
                                <li>En empresas de procesos bioalimentarios</li>
                                <li>Como analista de alimentos y diseño de nuevos productos</li>
                                <li>Como jefe de control de calidad alimentaria</li>
                        ...
                        <article class="carrera_texto2">
                            ...
                            <ul>
                                <li>Administrar los recursos y procesos alimentarios</li> 
                                <li>Diseñar y desarrollar productos y procesos alimentarios</li>
                                <li>Realizar investigación de técnicas de escalamiento de productos alimentarios</li>
                                <li>Elaborar proyectos para el sector alimentario</li>
                                <li>Evaluar los procesos de producción alimentaria</li>
                            </ul>
                        </article>
                        <div class="corte"></div>
                    </section>
