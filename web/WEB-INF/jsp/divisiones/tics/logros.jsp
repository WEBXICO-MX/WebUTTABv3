...
<html lang="es">
    <head>
        <title>UTTAB &#124; División académica de Tecnologías de la Información y Comunicación &#124; Logros</title>
        <meta charset="UTF-8">
        <meta name="author" content="Depto. Desarrollo de sistemas UTTAB">
        <meta name="description" content="Universidad Tecnológica de Tabasco,División académica de Tecnologías de la Información y Comunicación,Logros">
    ...
    <body>
        ...
        <div class="contenedor">
            ...
            <div class="area_botones_division">
                ...
                <a href="LogrosTIC" target="_self"><img src="img/divisionesUsoComun/logros.png" width="122" height="28" alt="Logros"  style="opacity:0.8;filter:alpha(opacity=80);"/></a>&nbsp;&nbsp;&nbsp;
            ...
            <div class="area_logros_division">
                <div class="area_logros_division_1">
                    ...
                    <div class="area_logros_division_info">
                        <p>Programa educativo de Tecnologías de la Información área Redes y Telecomunicaciones evaluado en nivel 1 por los Comités Interinstitucionales para la Evaluación de la Educación Superior Programa (CIEES).</p>
                    </div>
                    <div class="area_logros_division_img"><img src="img/divisionesUsoComun/tics/Logros.jpg" width="464" height="288" alt="area_logros_division_img"/>
                    </div>
                    <div class="corte"></div>
                </div>
                <div class="corte"></div>
                <div class="area_logros_division_2">
                    <div class="area_logros_division_info">
                        <p>Programa educativo de Tecnologías de la Información área Sistemas Informáticos evaluado en nivel 1 por los Comités Interinstitucionales para la Evaluación de la Educación Superior Programa (CIEES).</p>
                    </div>
                    <div class="area_logros_division_img"><img src="img/divisionesUsoComun/tics/Logros.jpg" width="464" height="288" alt="area_logros_division_img"/>
                    </div>
                    <div class="corte"></div>
