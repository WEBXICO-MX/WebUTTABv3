<%-- 
    Document   : index2
    Created on : 10-nov-2015, 15:38:12
    Author     : Weiss
--%>
        ...
        <main>
            ...
            <section class="carrera_section">
                <header class="carrera_titulo">
                    ...
                    <h1>TSU en Tecnologías de la Información y Comunicación área Sistemas Informáticos</h1>
                    <div class="corte"></div>
                </header>
                <article class="carrera_contenido">
                    <section class="carrera_portada">
                        <div>
                            <img src="${pageContext.request.contextPath}/img/divisiones/carreras/portada_ttsu_tic_sistemas_informaticos.jpg" alt="TSU en Tecnologías de la Información y Comunicación área Sistemas Informáticos"/>
                    ...
                    <section class="carrera_texto">
                        <article class="carrera_texto1">
                            ...
                            <ul>
                                <li>De forma independiente en consultorías de bienes y servicios</li>
                                <li>En su propia empresa de integración de soluciones de software</li>
                                <li>En empresas dedicadas al desarrollo y consultoría de software</li>
                                <li>En empresas públicas y privadas que demanden servicios de TI</li>
                                <li>En los sectores que requieran programadores de sistemas y/o diseñador web</li>
                            </ul><br/>
                        </article>
                        <article class="carrera_texto2">
                            <h3>¿Qué aprenderá durante la carrera?</h3>
                            <ul>
                                <li>Desarrollar sistemas de información a través de lenguajes de programación</li>
                                <li>A programar aplicaciones de software para dispositivos móviles</li>
                                <li>Planear proyectos informáticos según los requerimientos de las organizaciones</li>
                                <li>Implementar servidores de bases de datos</li>
                                <li>A desarrollar un sitio web ligado a una base de datos</li>
                            </ul>
                        </article>
                        <div class="corte"></div>
                    </section>
