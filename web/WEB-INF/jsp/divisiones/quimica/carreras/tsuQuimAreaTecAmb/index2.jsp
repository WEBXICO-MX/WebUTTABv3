<%-- 
    Document   : index2
    Created on : 10-nov-2015, 14:11:41
    Author     : Weiss
--%>
...
<html lang="es">
    <head>
        ...
        <meta name="description" content="Universidad Tecnológica de Tabasco,TSU en Química área Tecnología Ambiental">
        <meta name="keywords" content="TSU en Química área Tecnología Ambiental,tsu,educación,tecnologías,ingeniería,industrial,tecnológica,uttab,desarrollo,química,procesos,tabasco,universidad,servicios,gastronomía,page,comunicación,negocios,administración,aviso,proyectos,alumnos,escolar,mantenimiento,institucional,programa,competencias">
        <!--[if IE]>
        ...
        <main>
            <section class="carrera_section">
                <header class="carrera_titulo">
                    ...
                    <h1>TSU en Química área Tecnología Ambiental</h1>
                    <div class="corte"></div>
                </header>
                <article class="carrera_contenido">
                    <section class="carrera_portada">
                        <figure>
                            <img src="${pageContext.request.contextPath}/img/divisiones/carreras/portada_tsu_quimica_area_tecnologia_ambiental.png" alt="TSU en Química área Tecnología Ambiental"/>
                    ...
                    <section class="carrera_texto">
                        <article class="carrera_texto1">
                            ...
                            <ul>
                                <li>En empresas implementando sistemas de administración ambiental</li>
                                <li>En la industria elaborando programas de seguridad, higiene y control ambiental</li>
                                <li>Como consultor ambiental</li>
                                <li>En el manejo integral de residuos en el sector industrial y de servicios</li>
                                <li>Empresas dedicadas a la prestación de servicios ambientales</li>
                            </ul><br/>
                        </article>
                        <article class="carrera_texto2">
                            <h3>¿Qué aprenderá durante la carrera?</h3><br/><br/>
                            <ul>
                                <li>Elaborar programas de muestreo y análisis de contaminantes atmosféricos</li>
                                <li>Evaluar elementos de calidad ambiental con base en la normatividad</li>
                                <li>Uso de tecnologías y el análisis de sistemas para integrar programas ambientales</li>
                                <li>Elaborar planes de auditoria de los sistemas de gestión ambiental</li>
                                <li>Realizar análisis de suelo, agua y aire contaminados</li>
                            </ul>
                        </article>
                        <div class="corte"></div>
                    </section>
