                ...
                <article class="divisiones_contenido">
                    ...
                    <section class="divisiones_texto">
                        ...
                        <article class="divisiones_infraestructura">
                            <div class="ls-layer"><img src="${pageContext.request.contextPath}/img/divisiones/quimica/infraestructura1-min.png" alt="Infraestructura"/></div>
                            <div class="ls-layer"><img src="${pageContext.request.contextPath}/img/divisiones/quimica/infraestructura2-min.png" alt="Infraestructura"/></div>
                            <div class="ls-layer"><img src="${pageContext.request.contextPath}/img/divisiones/quimica/infraestructura3-min.png" alt="Infraestructura"/></div>
                            <div class="ls-layer"><img src="${pageContext.request.contextPath}/img/divisiones/quimica/infraestructura4-min.png" alt="Infraestructura"/></div>
                        </article>
                        <div class="corte"></div>
                    </section>
                    <section class="divisiones_texto">
                        ...
                        <article>
                            <section class="divisiones_texto cuerpo_academico left">
                                <img src="${pageContext.request.contextPath}/img/divisiones/quimica/cuerpo_academico1-min.png" alt="Cuerpo académico en consolidación: Conocimientos y tecnologías para el ambiente"/>
                                <header><h3>Cuerpo académico en consolidación: conocimientos y tecnologías para el ambiente</h3></header>
                                <article>
                            ...
                            <section class="divisiones_texto cuerpo_academico right">
                                <img src="${pageContext.request.contextPath}/img/divisiones/quimica/cuerpo_academico2-min.png" alt="Cuerpo académico en formación: Materiales y corrosión"/>
                                <header><h3>Cuerpo académico en formación: materiales y corrosión</h3></header>
                                <article>
