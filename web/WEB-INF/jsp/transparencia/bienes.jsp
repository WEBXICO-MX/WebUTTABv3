...
<html lang="es">
    <head>
        ...
        <meta name="keywords" content="transparencia,bienes,tsu,educación,tecnologías,ingeniería,industrial,tecnológica,uttab,desarrollo,química,procesos,tabasco,universidad,servicios,gastronomía,page,comunicación,negocios,administración,aviso,proyectos,alumnos,escolar,mantenimiento,institucional,programa,competencias">
            ...
            <section class="transparencia_section">
                ...
                <article class="transparencia_contenido">
                    <section class="transparencia_texto">
                        ...
                        <s:url var="url_bienes_5" action="viewFile" namespace="">
                           <s:param name="i" value="%{5}"></s:param>
                           <s:param name="d" value="%{'bienes'}"></s:param>
                         </s:url>
                        <ul>
                            <li><img src="${pageContext.request.contextPath}/img/Adobe-PDF-Document-icon.png" alt=""/>&nbsp;<s:a href="%{url_bienes_5}" target="_blank">BIENES MUEBLES E INMUEBLES CON CORTE AL 31 DE DICIEMBRE DEL 2016</s:a></li>
