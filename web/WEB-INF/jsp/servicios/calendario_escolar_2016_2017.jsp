...
<html lang="es">
    <head>
        ...
        <style>
            #contenedorCaleEscInte { margin:0 auto 0 auto; width: 1002px;height: 1650px; background-image:url('../img/servicios/calendarioEscolar/calendario_escolar_2016_2017/calendario_escolar_2016_2017_fondo.jpeg');background-size:1000px 1620px;background-repeat:no-repeat;border:1px solid transparent;position: relative;}
            @-moz-document url-prefix() {
                #contenedorCaleEscInte { margin:0 auto 0 auto; width: 1002px;height: 1680px; background-image:url('../img/servicios/calendarioEscolar/calendario_escolar_2016_2017/calendario_escolar_2016_2017_fondo.jpeg');background-size:1000px 1660px;background-repeat:no-repeat;border:1px solid transparent;position: relative;}
            }
    ...
    <body>
        <main>
            ...
            <div id="contenedorCaleEscInte">
                <div id="datepicker_titulo">Calendario Escolar 2016 - 2017</div>
                ...
                <div id="datepicker_otras_fechas">        
                    <div id="fecha1">
                        <p>Captura de calificaciones del 4to. parcial de la estadía</p>
                        <ul>
                        ...
                        <p>Análisis y compactación de grupos. Reinscripciones TSU y LIC</p>
                        <ul>
                    ...
                    <div id="fecha2">
                        <p>Recuperación ordinaria para competencias (todas las materias exepto estadía)</p>
                        <ul>
                        ...
                        <p>Grupos autorizados. Nuevo ingreso TSU</p>
                        <ul>
                    ...
                    <div id="fecha3">
                        <p>Grupos autorizados. Nuevo ingreso LIC</p>
                        <ul>
                            <li>05 diciembre 2016</li>
                            <li>03 abril 2017</li>
