            ...
            <section class="servicios_section">
                ...
                <article class="servicios_contenido">
                    <section class="servicios_texto_full">
                        <img src="${pageContext.request.contextPath}/img/servicios/centro_idiomas/ciut1-min.png" alt="Centro de Idiomas UT"/>
                    </section>
                    <section class="servicios_texto">
                        <p>El Centro de Idiomas imparte cursos de inglés, francés e italiano al público en general y a la comunidad universitaria.</p>
                       ...
                       <img src="${pageContext.request.contextPath}/img/servicios/centro_idiomas/ciut2-min.png" alt="Centro de Idiomas UT" style=" float: right; margin-left: 10px; margin-bottom: 10px"/>
                        <ul>
                        ...
                        <img src="${pageContext.request.contextPath}/img/servicios/centro_idiomas/ciut3-min.png" alt="Centro de Idiomas UT" style="float: right;margin-left: 10px; margin-bottom: 10px"/>
                        
                        <h3 style="margin-left: 43px;">Horario de atención:</h3>
                        <ul>
                            <li>Lunes a viernes de 08:00 a 17:00 horas</li>
                            <li>Sábados de 08:00 a 14:00 horas</li>
                            <li>Domingos de 09:00 a 14:00 horas</li>
                        </ul><br/>
                    </section>
                    <section class="servicios_texto">
