            ...
            <section class="servicios_section">
                ...
                <article class="servicios_contenido">
                    <section class="servicios_texto">
                        <figure><img src="${pageContext.request.contextPath}/img/servicios/admision/admision1-min.png" alt="Admisión a la UTTAB"/></figure><br/>
                        <p>Si eres egresado de bachiller y deseas continuar tu formación profesional con nosotros es importante saber que la Universidad Tecnológica de Tabasco tiene ingreso de alumnos a los niveles Técnico Superior Universitario y Licenciatura en los periodos septiembre-diciembre, enero-abril y mayo-agosto.</p><br/>
                        <p class="negritas">Requisitos generales para nuevo ingreso:</p><br/>
                        <ul>
                        ...
                        <section class="servicios_texto">
                            ...
                            <p><span class="negritas">Etapa 1:</span> aspirante a la UT</p><br/>
                            <ul>
                            ...
                            <p><span class="negritas">Etapa 2:</span> el alumno aceptado:</p><br/> 
                            <ul><li>Realizar el trámite de inscripción correspondiente</li></ul> <br/>
                            <p><span class="negritas">Etapa 3:</span> inscripciones al nivel Técnico Superior Universitario: </p><br/> 
                            <p>Requisitos: </p><br/>
                            <ul>
                        ...
                        <section class="servicios_texto">
                            ...
                            <p><span class="negritas">Etapa 1:</span> aspirante a la continuidad de estudios</p><br/>
                            <ul>
                            ...
                            <p><span class="negritas">Etapa 2:</span> inscripción al nivel Licenciatura</p> <br/>
                            <p>Requisitos:</p><br/>
                            <ul>
