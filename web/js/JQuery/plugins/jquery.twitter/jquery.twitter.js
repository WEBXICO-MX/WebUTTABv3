	...
	$.fn.getTwitter = function(options) {
		...
		return this.each(function() {
			...
			// window.jsonTwitterFeed = "https://api.twitter.com/1.1/statuses/user_timeline.json?include_rts="+o.includeRetweets+"&excludeReplies="+o.excludeReplies+"&screen_name="+o.userName+"&count="+(o.numTweets + 20);
                        //window.jsonTwitterFeed = "http://localhost:90/javascript_ebook_source_code/user_timeline.php?include_rts="+o.includeRetweets+"&excludeReplies="+o.excludeReplies+"&screen_name="+o.userName+"&count="+(o.numTweets + 20);
			window.jsonTwitterFeed = 'getJsonTwitter.action';   
                       $.ajax({
				url: jsonTwitterFeed,
				data: {},
				/*dataType: "jsonp",
